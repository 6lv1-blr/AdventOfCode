object Form6: TForm6
  ...
  object Label2: TLabel
    ...
    Width = 200
    Height = 15
    Caption = 'Coller le code g'#233'n'#233'rer dans OpenScad'
  end
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet3: TTabSheet
      Caption = 'TabSheet3'
      ImageIndex = 2
      object MemoScriptOpenScad: TMemo
        Left = 0
        Top = 0
        Width = 756
        Height = 590
  ...
  object Button1: TButton
    ...
    Width = 204
    Height = 25
    Caption = 'Copier le script dans le presse papier'
    TabOrder = 9
  ...
  object Memo1: TMemo
    ...
    Height = 118
    Lines.Strings = (
      'Pour le moment je n'#39'ai pas trouv'#233' de '
      'logiciel pour calculer mon volume de '
      'facon fiable sur le stl'
      'je suis '#224' 2mmcube sur le jeu '
      'd'#39'exemple en diff'#233'rence'
      ''
      '')
    TabOrder = 10
  end
